sap.ui.define([
		...
		return BaseObject.extend("xperi.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias xperi.model.ListSelector
			 */
			 ...
			 * @return {xperi.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
